...
<head>
    ...
    <link href="public/build/css/signup.css" rel="stylesheet" />
</head>
                ...
                <section class="login_content">
                    <form action="auth/signup" method="post">
                        ...
                        <div style="display: flex; justify-content: space-between ">
                            <button class="btn btn-primary" style="margin-left: 40px;">Sign up</button>
                            <a href="dang-nhap.html" style="color: blue; text-decoration: underline;font-size:20px;">Đăng nhập</a>
                        </div>
